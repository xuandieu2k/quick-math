...
import com.dhug.example.base.ui.dialog.WaitDialog
import com.cooldev.base.BaseActivity
import com.cooldev.base.BaseDialog
import com.dhug.example.R
import com.dhug.example.base.action.TitleBarAction
import com.dhug.example.base.ui.activity.SplashActivity
import com.dhug.example.data.ads.OpenAdManager
import com.dhug.example.presentation.view.activity.PaywallActivity
import com.dhug.example.presentation.viewmodel.PremiumViewModel
import com.dhug.example.presentation.viewmodel.RemoteConfigViewModel
...
@AndroidEntryPoint
abstract class AppActivity : BaseActivity(), TitleBarAction {
     ...
     */
    protected abstract fun isHasInterstitialAd(): Boolean
...
//        }
    ...
    private fun registerObserve() {
        if (!remoteConfigViewModel.configData.hasActiveObservers()) {
...
//                if (remoteConfig.isShowAdsInterstitial && isHasInterstitialAd()) InterstitialAdManager.startAdControlAuto(
//                    this
//                ) else InterstitialAdManager.stopAdControl()
    ...
    private fun reOpenAds() {
        if (InterstitialAdManager.getInterstitialAd() == null && this !is SplashActivity && this !is PaywallActivity) {
        ...
        if (openAdManager.getOpenAd() == null && this !is SplashActivity && this !is PaywallActivity) {
    ...
    private fun handleConfigData(configData: Map<String, Any>) {
        Timber.d("Remote Config Data: $configData")
    }
