...
import com.dhug.quick_math.databinding.FragmentCompetitionBinding
import com.dhug.quick_math.presentation.adapter.HistoryAdapter
import com.dhug.quick_math.presentation.viewmodel.CompetitionViewModel
 ...
 * All rights reserved.
 *
 * File Name:    CompetitionFragment.kt
 * Author:       NGUYỄN XUÂN DIỆU
 * Created Date: 12/4/25 at 10:49
 * Description: File CompetitionFragment.kt created by admin - 12/4/25 at 10:49
 */

@AndroidEntryPoint
class CompetitionFragment : AppFullFragment() {
