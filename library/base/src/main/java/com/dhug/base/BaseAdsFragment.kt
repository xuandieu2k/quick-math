...
@AndroidEntryPoint
abstract class BaseAdsFragment : Fragment(),
    HandlerAction, ClickAction, BundleAction, KeyboardAction {

    /** Activity object */
    private var activity: BaseAdsActivity? = null
    ...
    override fun onAttach(context: Context) {
        ...
        activity = requireActivity() as? BaseAdsActivity
    }
     ...
     */
    open fun getAttachActivity(): BaseAdsActivity? {
        return activity
    }
     ...
     */
    open fun startActivityForResult(clazz: Class<out Activity>, callback: BaseAdsActivity.OnActivityCallback?) {
        activity?.startActivityForResult(clazz, callback)
    }

    open fun startActivityForResult(intent: Intent, callback: BaseAdsActivity.OnActivityCallback?) {
    ...
    open fun startActivityForResult(
        intent: Intent,
        options: Bundle?,
        callback: BaseAdsActivity.OnActivityCallback?
    ) {
